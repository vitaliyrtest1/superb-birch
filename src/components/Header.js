            	...
            	<div className="container">
            		<nav className="navbar flex items-center" aria-label="Main Navigation">
            			...
            			<div className="navbar__branding mr-2">
            				...
            				<Link className="navbar__logo m-0" href={withPrefix('/')}><img src={withPrefix(_.get(this.props, 'data.config.header.logo', null))} alt={_.get(this.props, 'data.config.header.title', null)} /></Link>
            				) : 
