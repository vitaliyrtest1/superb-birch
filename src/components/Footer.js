                		...
                		<div className="container">
                			<div className={classNames('grid', {'justify-md-center': has_logo === false})}>
                				...
                				<Link className="site-footer__logo cell-12 cell-md-5 my-4" href={withPrefix('/')}>
                					<img src={withPrefix(_.get(this.props, 'data.config.footer.logo', null))} alt={_.get(this.props, 'data.config.header.title', null)} />
                				</Link>
                				)}
                				...
                				<div className={classNames('site-footer__social', 'cell-12', {'cell-sm-auto': footer_content})}>
                					{_.map(_.get(this.props, 'data.config.footer.social_links', null), (link, link_idx) => {
                					    ...
                					    return (
                    						...
                    						<Link key={link_idx} className={classNames('btn', 'btn--icon', {'btn--primary': link_style === 'primary', 'btn--secondary': link_style === 'secondary', 'btn--clear': link_style === 'link'})} href={withPrefix(_.get(link, 'url', null))} {...(_.get(link, 'new_window', null) ? ({target: '_blank', rel: 'noopener'}) : null)}>
